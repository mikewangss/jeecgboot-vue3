...
const NEWS_LIST = PageEnum.NEWS_LIST;
const NEWS_DETAIL = PageEnum.NEWS_DETAIL;
//auth2登录路由
...
const whitePathList: PageEnum[] = [LOGIN_PATH, OAUTH2_LOGIN_PAGE_PATH, SYS_FILES_PATH, TOKEN_LOGIN, HOME, NEWS_DETAIL, NEWS_LIST];
