<template>
  <div class="step1">
    ...
    <p>
      ...
      （4）业绩证明（过去三年承接项目和目前在建项目）； * 文件命名为“业绩证明” * 过去三年承接项目至少需填写3条业绩 （5）相应资质证书；
      （6）实际履约项目经理资料； 1. 身份证复印件正反面； 2. 建造师复印件(如有)； 3. 连续6个月社保证明(文件命名为“连续6个月社保证明”) 4.
      三年内业绩证明(合同首页、盖章页、项目经理名称页,或可上传一个合同，文件命名为“三年内业绩证明”)； （7）开户银行许可证及银行信息登记表；
    </p>
  </div>
</template>
<script lang="ts">
