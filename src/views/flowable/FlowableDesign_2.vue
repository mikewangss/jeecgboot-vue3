    ...
    <a-layout-content style="padding: 0 50px">
      <a-layout style="padding: 24px 0; background: #fff">
        ...
        <a-layout-content :style="{ padding: '0 24px', minHeight: '280px' }">
          ...
          />
          <PropertiesPanel :key="`penal-${reloadIndex}`" :bpmn-modeler="modeler" :prefix="controlForm.prefix" class="process-panel" />
          ...
          <el-drawer v-model="controlDrawerVisible" size="400px" title="偏好设置" append-to-body destroy-on-close>
            <el-form :model="controlForm" size="small" label-width="100px" class="control-form" @submit.prevent>
              ...
              <el-switch v-model="pageMode" active-text="dark" inactive-text="light" @change="changePageMode" />
            </el-form>
          </el-drawer>
        </a-layout-content>
      </a-layout>
