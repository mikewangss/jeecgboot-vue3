...
<script>
  import UserTask from '@/package/penal/task/task-components/UserTask.vue';
  import ScriptTask from '@/package/penal/task/task-components/ScriptTask.vue';
  import ReceiveTask from '@/package/penal/task/task-components/ReceiveTask.vue';
